...
const BusinessSummary = () => {
    return (
        <div className="container my-14 px-6 mx-auto">
            <h1 className='text-3xl font-bold mb-6 text-gray-800 text-center mb-10'>Business Summary</h1>
            <section className="mb-32 text-gray-800 text-center">
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 lg:gap-x-0 items-center">
                    <div className="mb-12 lg:mb-0 relative">
                        ...
                        <h5 className="text-lg font-medium text-blue-600 font-bold mb-4">5000+</h5>
                    ...
                    <div className="mb-12 lg:mb-0 relative">
                        ...
                        <h5 className="text-lg font-medium text-blue-600 font-bold mb-4">490+</h5>
                    ...
                    <div className="relative">
                        ...
                        <h5 className="text-lg font-medium text-blue-600 font-bold mb-4">28</h5>
